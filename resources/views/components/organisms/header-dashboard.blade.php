<aside
    ...
    <div class="h-19.5">
        <i class="absolute top-0 right-0 hidden p-4 opacity-50 cursor-pointer fas fa-times text-slate-400 xl:hidden"
            sidenav-close></i>
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="{{ route('user.index') }}">
            <img src="https://codingcollective.com/wp-content/uploads/2024/10/logo-co2.png"
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
                <a class="
                {{ __('Dashboard') === trim($__env->yieldContent('title'))
                    ...
                    <div
                        ...
                        @if (__('Dashboard') === trim($__env->yieldContent('title')))
            ...
            <li class="mt-0.5 w-full">
                <a class="
                {{ __('Employees') === trim($__env->yieldContent('title'))
                    ? 'py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors'
                    : 'py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors' }}"
                    ...
                    <div
                        ...
                        @if (__('Employees') === trim($__env->yieldContent('title')))
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Employees</span>
                </a>
            </li>
        </ul>
    </div>
